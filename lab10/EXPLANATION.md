...
В данной лабораторной работе API магазина (`shop-back`) было переработано с использованием различных паттернов представлений Django REST Framework (DRF). Реализация разделена на 4 уровня сложности и абстракции.
...
## Новые эндпоинты
После рефакторинга доступны следующие пути (маршруты):
...
```
Протестировать все эндпоинты можно через Postman.
